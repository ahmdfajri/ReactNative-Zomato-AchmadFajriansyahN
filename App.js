...
import { Container, Header, Button, Content, Text, Thumbnail, Left, List, ListItem, Body, Item, Icon, Input, Card, CardItem , Right } from 'native-base';
...
class App extends Component {
  ...
  cariresto(){
    ...
    var config = {
      headers:{'user-key':'e9c78a3f745ba2a43fc7252c3f27ab76'}
    };
